...
from .unet import SuperResModel, UNetModel, EncoderUNetModel, SemanticEncoder
...
def create_encoder(
    ...
    encoder_pool="adaptive",
):
    if image_size == 512:
        channel_mult = (0.5, 0.5, 1, 1, 2, 2, 4, 4)
    elif image_size == 256:
