...
class LossType(enum.Enum):
    MAE = enum.auto()  # use raw MAE loss (and KL when learning variances)
    RESCALED_MAE = (
        enum.auto()
...
class GaussianDiffusion:
    ...
    def training_losses(self, model, x_start, t, model_kwargs=None, noise=None):
        ...
        if self.loss_type == LossType.KL or self.loss_type == LossType.RESCALED_KL:
        ...
        elif self.loss_type == LossType.MAE or self.loss_type == LossType.RESCALED_MAE:
            ...
            if self.model_var_type in [
                ...
                if self.loss_type == LossType.RESCALED_MAE:
            ...
            terms["mae"] = mean_flat((target - model_output)) # ** 2
            if "vb" in terms:
                terms["loss"] = terms["mae"] + terms["vb"]
            else:
                terms["loss"] = terms["mae"]
        else:
